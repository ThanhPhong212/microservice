...
exports.CUDtypeApartment = yup.object().shape({
  ...
  bedroom: yup.number().typeError('Số lượng phải là chữ số!').integer('Số lượng phòng ngủ không được là thập phân!').min(0, 'Số lượng phòng ngủ không được là số âm!')
    .nullable(true),
  kitchen: yup.number().typeError('Số lượng phải là chữ số!').integer('Số lượng nhà bếp không được là thập phân!').min(0, 'Số lượng nhà bếp không được là số âm!').nullable(true),
  toilet: yup.number().typeError('Số lượng phải là chữ số!').integer('Số lượng nhà vệ sinh không được là thập phân!').min(0, 'Số lượng nhà vệ sinh không được là số âm!').nullable(true),
  balcony: yup.number().typeError('Số lượng phải là chữ số!').integer('Số lượng ban công không được là số thập phân!').min(0, 'Số lượng ban công không được là số âm!').nullable(true),
